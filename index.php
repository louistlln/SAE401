                ...
                <div class="projects-content">
                    <?php
                        for($i = 0; $i < count($projets); $i++) {
                            echo "<div class='projects'><a href='" . $projets[$i]['url'] . "' target='_blank' class='projects-links'><div><h1>" . $projets[$i]['dossier'] . "</h1>" . $projets[$i]['tiny_contenu'] . "<span>Par " . $projets[$i]['auteur'] . " le " . $projets[$i]['date'] . "</span></div></a></div>";
                        }
                    ?>
                </div>
            </section>
